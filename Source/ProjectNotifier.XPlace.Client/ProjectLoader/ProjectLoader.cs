namespace ProjectNotifier.XPlace.Client
{
    ...
    public class ProjectLoader : IProjectLoader
    {
        ...
        public ProjectLoader(ClientAppSettingsModel settings, string url)
        {
            _settings = settings;
            _url = url;
        }
        ...
        public async Task<IEnumerable<ProjectModel>> LoadProjectsAsync(CancellationToken cancellationToken = default)
        {
            ...
            var projects = (await GetXElementNodeListAsync(count: _settings.ProjectsToDisplay, cancellationToken: cancellationToken))
